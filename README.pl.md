...
Projekt posiada **57 testów automatycznych** (Unit + Functional) z **99.6% pokryciem kodu**:
...
Wynik:
* **PHPStan Level 8**: `[OK] No errors` (35 plików)
* **PHPUnit 13**: `OK (57 tests, 189 assertions)`
* **Code Coverage**: `99.65% lines covered`
